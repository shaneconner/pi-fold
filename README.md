...
Folding does not require a memory store. The measured pairing below used [pi-canon](https://github.com/shaneconner/pi-canon), built alongside this and installed separately.
